import type { GetBooksResponse } from "../../../src/api/books";
...
export const getBooksResponse: GetBooksResponse = {
  books: [
    {
      author: "Louis Young",
      coverImageUrl:
...
export const mockGetBooksResponse = ({
  parameters,
  response,
}: MockResponseFunctionParameters<
  { searchQuery: string },
  GetBooksResponse
>) => {
  return cy.intercept(
    {
      ...
      url: constructAbsoluteUrl(
        "https://api.books.com",
        appendSearchParametersToPath("/books", {
